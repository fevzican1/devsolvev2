...
const footerLinks = {
  ...
  fixes: [
    { href: '/fix/python-requests-2-31-0-jsondecodeerror', label: 'requests JSONDecodeError' },
    { href: '/fix/python-pandas-2-2-0-settingwithcopywarning', label: 'pandas SettingWithCopyWarning' },
    { href: '/fix/javascript-axios-1-6-0-err-bad-request-400', label: 'axios 400 Bad Request' },
    { href: '/fix/java-jackson-databind-2-16-0-unrecognizedpropertyexception', label: 'Jackson Unrecognized Field' },
  ],
    ...
    <footer className="border-t bg-muted/50">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <div>
            <h3 className="font-semibold mb-4">Error Fixes</h3>
            <ul className="space-y-2">
              {footerLinks.fixes.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-muted-foreground hover:text-foreground transition-colors"
